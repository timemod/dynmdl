...
var l_1 l_2 l_3 l_4 l_5 l_6 l_7 ;
varexo fit_y fit_yd fit_c fit_i fit_md fit_r fit_t ;
varexo y_exo yd_exo c_exo i_exo md_exo r_exo t_exo ;
...
fit_y * ( y - y_exo ) + (1 - fit_y ) * ( l_5(1) * (-i1) + l_1 * (-t1) + l_2 * 1
    + l_3 * (-1) + l_5 * (-i2) + l_6 * (-m1) + l_5(-1) * (-i3) ) = 0;
fit_yd * ( yd - yd_exo ) + (1 - fit_yd ) * ( l_4(1) * (-c1) + l_3 * 1 + l_4 *
    (-c2) + l_4(-1) * (-c3) ) = 0;
