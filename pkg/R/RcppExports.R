...
compile_model_ <- function(modfile, latex_basename, use_dll, dll_dir, max_laglead_1, strict, internal_calc, n_fit_derivatives, warn_uninit_param, latex_options) {
    .Call(`_dynmdl_compile_model_`, modfile, latex_basename, use_dll, dll_dir, max_laglead_1, strict, internal_calc, n_fit_derivatives, warn_uninit_param, latex_options)
}
