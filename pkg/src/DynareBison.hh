...
#line 146 "DynareBison.hh" // lalr1.cc:377
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        LOAD_STAB = 659,
        ALPHA2_STAB = 660,
        LOGTRANS_REDFORM = 661,
        THRESHOLD_REDFORM = 662,
        KSSTAT_REDFORM = 663,
        ALPHA2_REDFORM = 664,
        NAMENDO = 665,
        NAMLAGENDO = 666,
        ...
        VLISTLOG = 684,
        VLISTPER = 685,
        SPECTRAL_DENSITY = 686,
        RESTRICTION = 687,
        RESTRICTION_FNAME = 688,
        CROSS_RESTRICTIONS = 689,
        NLAGS = 690,
        CONTEMP_REDUCED_FORM = 691,
        REAL_PSEUDO_FORECAST = 692,
        DUMMY_OBS = 693,
        NSTATES = 694,
        INDXSCALESSTATES = 695,
        NO_BAYESIAN_PRIOR = 696,
        SPECIFICATION = 697,
        SIMS_ZHA = 698,
        ALPHA = 699,
        BETA = 700,
        ...
        INDXGDLS = 740,
        EQ_MS = 741,
        FILTER_COVARIANCE = 742,
        FILTER_DECOMPOSITION = 743,
        SMOOTHED_STATE_UNCERTAINTY = 744,
        EQ_CMS = 745,
        TLINDX = 746,
        TLNUMBER = 747,
        BANACT = 748,
        RESTRICTIONS = 749,
        POSTERIOR_SAMPLER_OPTIONS = 750,
        OUTPUT_FILE_TAG = 751,
        DRAWS_NBR_BURN_IN_1 = 752,
        DRAWS_NBR_BURN_IN_2 = 753,
        HORIZON = 754,
        SBVAR = 755,
        TREND_VAR = 756,
        DEFLATOR = 757,
        GROWTH_FACTOR = 758,
        MS_IRF = 759,
        MS_VARIANCE_DECOMPOSITION = 760,
        MS_ESTIMATION = 761,
        MS_SIMULATION = 762,
        MS_COMPUTE_MDD = 763,
        MS_COMPUTE_PROBABILITIES = 764,
        MS_FORECAST = 765,
        SVAR_IDENTIFICATION = 766,
        EQUATION = 767,
        EXCLUSION = 768,
        LAG = 769,
        UPPER_CHOLESKY = 770,
        ...
        MONTHLY = 772,
        QUARTERLY = 773,
        MARKOV_SWITCHING = 774,
        CHAIN = 775,
        DURATION = 776,
        NUMBER_OF_REGIMES = 777,
        NUMBER_OF_LAGS = 778,
        SVAR = 779,
        SVAR_GLOBAL_IDENTIFICATION_CHECK = 780,
        COEFF = 781,
        COEFFICIENTS = 782,
        VARIANCES = 783,
        CONSTANTS = 784,
        EQUATIONS = 785,
        EXTERNAL_FUNCTION = 786,
        EXT_FUNC_NAME = 787,
        EXT_FUNC_NARGS = 788,
        FIRST_DERIV_PROVIDED = 789,
        SECOND_DERIV_PROVIDED = 790,
        SELECTED_VARIABLES_ONLY = 791,
        COVA_COMPUTE = 792,
        SIMULATION_FILE_TAG = 793,
        FILE_TAG = 794,
        NO_ERROR_BANDS = 795,
        ERROR_BAND_PERCENTILES = 796,
        SHOCKS_PER_PARAMETER = 797,
        NO_CREATE_INIT = 798,
        SHOCK_DRAWS = 799,
        FREE_PARAMETERS = 800,
        MEDIAN = 801,
        DATA_OBS_NBR = 802,
        NEIGHBORHOOD_WIDTH = 803,
        PVALUE_KS = 804,
        PVALUE_CORR = 805,
        FILTERED_PROBABILITIES = 806,
        REAL_TIME_SMOOTHED = 807,
        PRIOR_FUNCTION = 808,
        POSTERIOR_FUNCTION = 809,
        SAMPLING_DRAWS = 810,
        PROPOSAL_TYPE = 811,
        PROPOSAL_UPPER_BOUND = 812,
        PROPOSAL_LOWER_BOUND = 813,
        PROPOSAL_DRAWS = 814,
        USE_MEAN_CENTER = 815,
        ADAPTIVE_MH_DRAWS = 816,
        THINNING_FACTOR = 817,
        COEFFICIENTS_PRIOR_HYPERPARAMETERS = 818,
        CONVERGENCE_STARTING_VALUE = 819,
        CONVERGENCE_ENDING_VALUE = 820,
        CONVERGENCE_INCREMENT_VALUE = 821,
        MAX_ITERATIONS_STARTING_VALUE = 822,
        MAX_ITERATIONS_INCREMENT_VALUE = 823,
        MAX_BLOCK_ITERATIONS = 824,
        MAX_REPEATED_OPTIMIZATION_RUNS = 825,
        FUNCTION_CONVERGENCE_CRITERION = 826,
        SAVE_REALTIME = 827,
        PARAMETER_CONVERGENCE_CRITERION = 828,
        NUMBER_OF_LARGE_PERTURBATIONS = 829,
        NUMBER_OF_SMALL_PERTURBATIONS = 830,
        NUMBER_OF_POSTERIOR_DRAWS_AFTER_PERTURBATION = 831,
        MAX_NUMBER_OF_STAGES = 832,
        RANDOM_FUNCTION_CONVERGENCE_CRITERION = 833,
        RANDOM_PARAMETER_CONVERGENCE_CRITERION = 834,
        SYMBOL_VEC = 835
      };
    };
  ...
  private:
    ...
    enum
    {
      ...
      yyterror_ = 1,
      yyerrcode_ = 256,
      yyntokens_ = 589  ///< Number of tokens.
    };
...
#line 1067 "DynareBison.hh" // lalr1.cc:377
