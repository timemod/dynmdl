...
#line 146 "DynareBison.hh" // lalr1.cc:377
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        LOAD_STAB = 658,
        ALPHA2_STAB = 659,
        LOGTRANS_REDFORM = 660,
        THRESHOLD_REDFORM = 661,
        KSSTAT_REDFORM = 662,
        ALPHA2_REDFORM = 663,
        NAMENDO = 664,
        NAMLAGENDO = 665,
        ...
        VLISTLOG = 683,
        VLISTPER = 684,
        SPECTRAL_DENSITY = 685,
        RESTRICTION = 686,
        RESTRICTION_FNAME = 687,
        CROSS_RESTRICTIONS = 688,
        NLAGS = 689,
        CONTEMP_REDUCED_FORM = 690,
        REAL_PSEUDO_FORECAST = 691,
        DUMMY_OBS = 692,
        NSTATES = 693,
        INDXSCALESSTATES = 694,
        NO_BAYESIAN_PRIOR = 695,
        SPECIFICATION = 696,
        SIMS_ZHA = 697,
        ALPHA = 698,
        BETA = 699,
        ...
        INDXGDLS = 739,
        EQ_MS = 740,
        FILTER_COVARIANCE = 741,
        FILTER_DECOMPOSITION = 742,
        SMOOTHED_STATE_UNCERTAINTY = 743,
        EQ_CMS = 744,
        TLINDX = 745,
        TLNUMBER = 746,
        BANACT = 747,
        RESTRICTIONS = 748,
        POSTERIOR_SAMPLER_OPTIONS = 749,
        OUTPUT_FILE_TAG = 750,
        DRAWS_NBR_BURN_IN_1 = 751,
        DRAWS_NBR_BURN_IN_2 = 752,
        HORIZON = 753,
        SBVAR = 754,
        TREND_VAR = 755,
        DEFLATOR = 756,
        GROWTH_FACTOR = 757,
        MS_IRF = 758,
        MS_VARIANCE_DECOMPOSITION = 759,
        MS_ESTIMATION = 760,
        MS_SIMULATION = 761,
        MS_COMPUTE_MDD = 762,
        MS_COMPUTE_PROBABILITIES = 763,
        MS_FORECAST = 764,
        SVAR_IDENTIFICATION = 765,
        EQUATION = 766,
        EXCLUSION = 767,
        LAG = 768,
        UPPER_CHOLESKY = 769,
        ...
        MONTHLY = 771,
        QUARTERLY = 772,
        MARKOV_SWITCHING = 773,
        CHAIN = 774,
        DURATION = 775,
        NUMBER_OF_REGIMES = 776,
        NUMBER_OF_LAGS = 777,
        SVAR = 778,
        SVAR_GLOBAL_IDENTIFICATION_CHECK = 779,
        COEFF = 780,
        COEFFICIENTS = 781,
        VARIANCES = 782,
        CONSTANTS = 783,
        EQUATIONS = 784,
        EXTERNAL_FUNCTION = 785,
        EXT_FUNC_NAME = 786,
        EXT_FUNC_NARGS = 787,
        FIRST_DERIV_PROVIDED = 788,
        SECOND_DERIV_PROVIDED = 789,
        SELECTED_VARIABLES_ONLY = 790,
        COVA_COMPUTE = 791,
        SIMULATION_FILE_TAG = 792,
        FILE_TAG = 793,
        NO_ERROR_BANDS = 794,
        ERROR_BAND_PERCENTILES = 795,
        SHOCKS_PER_PARAMETER = 796,
        NO_CREATE_INIT = 797,
        SHOCK_DRAWS = 798,
        FREE_PARAMETERS = 799,
        MEDIAN = 800,
        DATA_OBS_NBR = 801,
        NEIGHBORHOOD_WIDTH = 802,
        PVALUE_KS = 803,
        PVALUE_CORR = 804,
        FILTERED_PROBABILITIES = 805,
        REAL_TIME_SMOOTHED = 806,
        PRIOR_FUNCTION = 807,
        POSTERIOR_FUNCTION = 808,
        SAMPLING_DRAWS = 809,
        PROPOSAL_TYPE = 810,
        PROPOSAL_UPPER_BOUND = 811,
        PROPOSAL_LOWER_BOUND = 812,
        PROPOSAL_DRAWS = 813,
        USE_MEAN_CENTER = 814,
        ADAPTIVE_MH_DRAWS = 815,
        THINNING_FACTOR = 816,
        COEFFICIENTS_PRIOR_HYPERPARAMETERS = 817,
        CONVERGENCE_STARTING_VALUE = 818,
        CONVERGENCE_ENDING_VALUE = 819,
        CONVERGENCE_INCREMENT_VALUE = 820,
        MAX_ITERATIONS_STARTING_VALUE = 821,
        MAX_ITERATIONS_INCREMENT_VALUE = 822,
        MAX_BLOCK_ITERATIONS = 823,
        MAX_REPEATED_OPTIMIZATION_RUNS = 824,
        FUNCTION_CONVERGENCE_CRITERION = 825,
        SAVE_REALTIME = 826,
        PARAMETER_CONVERGENCE_CRITERION = 827,
        NUMBER_OF_LARGE_PERTURBATIONS = 828,
        NUMBER_OF_SMALL_PERTURBATIONS = 829,
        NUMBER_OF_POSTERIOR_DRAWS_AFTER_PERTURBATION = 830,
        MAX_NUMBER_OF_STAGES = 831,
        RANDOM_FUNCTION_CONVERGENCE_CRITERION = 832,
        RANDOM_PARAMETER_CONVERGENCE_CRITERION = 833,
        SYMBOL_VEC = 834
      };
    };
...
#line 1066 "DynareBison.hh" // lalr1.cc:377
