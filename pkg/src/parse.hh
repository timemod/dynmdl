...
ModFile *parse(char * modfile, char *latex_basename, bool max_laglead_1, 
               ...
               bool warn_uninit_param, const OutputParameters &output_params);
...
ModFile *parse_post_macro(stringstream &in, string &latex_basename, bool debug,
      ...
      bool warn_uninit_param, bool console,
      ...
      int n_fit_derivatives, const OutputParameters &output_params
