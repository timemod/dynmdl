...
ModFile* parse(char * modfile, const string &latex_dir, const string &latex_prefix,
               bool max_laglead_1, bool nostrict, bool no_tmp_terms, bool fit_deriv, 
               int n_fit_derivatives, bool warn_uninit_param,
  ...
  // Do the rest
  ModFile *mod_file = parse_post_macro(macro_output, latex_dir, latex_prefix, 
        debug, clear_all, clear_global,
        ...
        compute_xrefs, output_mode, language, params_derivs_order, max_laglead_1, fit_deriv,
