...
clean_dynare('kern_20x20_v4_leads_fit', 'temp', true)
...
dlmwrite('output/kern_20x20_v4_leads_fit_eigval.csv', eigval)
dlmwrite('output/kern_20x20_v4_leads_fit_steady.csv', oo_.steady_state)
