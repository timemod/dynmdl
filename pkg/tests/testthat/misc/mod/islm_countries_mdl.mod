...
% in dynmdl it is not yet possible to specify an include path,
% therefore we specify the path relative to the directory from which
% the job is run
@#include "mod/islm_countries_tot.mod"
