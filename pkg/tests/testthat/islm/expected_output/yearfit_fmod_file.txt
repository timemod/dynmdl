...
fit_y * ( y - y_exo ) + (1 - fit_y ) * ( l_8(3) * ((-0.25)) + l_8(2) *
    ((-0.25)) + l_5(1) * ((-i1)) + l_8(1) * ((-0.25)) + l_1 * (1) + l_2 *
    ((-1)) + l_3 * ((-t1)) + l_5 * ((-i2)) + l_6 * ((-m1)) + l_8 * ((-0.25)) +
    l_5(-1) * ((-i3)) ) = 0;
fit_yd * ( yd - yd_exo ) + (1 - fit_yd ) * ( l_4(1) * ((-c1)) + l_2 * (1) + l_4
    * ((-c2)) + l_4(-1) * ((-c3)) ) = 0;
