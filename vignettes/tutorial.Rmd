...
```{r}
mdl$set_endo_values(1200, names = "y", period = "2014")
mdl$set_endo_values(1000, names = "yd", period = "2014")
```

Further suppose that in 2015 we know the intended government spending:
```{r}
mdl$set_exo_values(280, names = "g", period = "2015")
```
